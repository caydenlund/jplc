...
namespace generator {
    ...
    generator::stack_info::int_stack::int_stack() : last(nullptr), total(0) {}

    unsigned int generator::stack_info::int_stack::get_total() const { return this->total; }

    unsigned int generator::stack_info::int_stack::pop() {
    ...
    void generator::stack_info::int_stack::push(unsigned int value) {
    ...
    bool generator::stack_info::needs_alignment() const { return this->stack.get_total() % stack_alignment > 0; }

    unsigned int generator::stack_info::pop() { return this->stack.pop(); }

    void generator::stack_info::push(unsigned int num_bytes) { this->stack.push(num_bytes); }
