...
namespace generator {
    ...
    protected:
        ...
        /**
         * @brief The optimization level for the generated assembly.
         *
         */
        ...
        /**
         * @brief Reports whether the given integer fits into 32 bits.
         *
         * @param value The value to check.
         * @return True when the value fits within 32 bits; false otherwise.
         */
        static bool fits_into_32(long value);

        /**
         * @brief Returns the log_2 of the given value, or 0 if the given value is not a power of 2.
         *
         * @param value The value to check.
         * @return The log_2 of the given value, or 0 if the given value is not a power of 2.
         */
        static long log_2(long value);
    ...
    public:
         ...
         * @param opt_level The optimization level for the generated assembly.
         */
    ...
    public:
        ...
        main_generator(const std::shared_ptr<symbol_table::symbol_table>& global_symbol_table,
                       const std::vector<std::shared_ptr<ast_node::ast_node>>& nodes, bool debug, unsigned opt_level);
