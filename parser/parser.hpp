...
namespace parser {
    ...
    */
     ...
     * @details The AST nodes in the sequence must be delimited by commas.
     *
    ...
    /**
     * @brief Finds the index of the next token of the given type.
     *
     * @param tokens The set of tokens to search.
     * @param start_index The start index from which to search.
     * @param type The type of token for which to search.
     * @return The index of the next token of the given type, or 0 if none is found.
     */
    ...
    */
     ...
     *
     */
    const std::vector<parser_t> command_parsers{parse_cmd_assert, parse_cmd_fn, parse_cmd_let, parse_cmd_print, parse_cmd_read, parse_cmd_show, parse_cmd_time, parse_cmd_type, parse_cmd_write};

    /**
     * @brief The set of expression parsers.
     *
     */
    const std::vector<parser_t> expression_parsers{parse_expr_array_index, parse_expr_array_literal, parse_expr_call, parse_expr_false, parse_expr_float, parse_expr_integer, parse_expr_true, parse_expr_tuple_index, parse_expr_tuple_literal, parse_expr_variable};
     ...
     *
     */
    const std::vector<parser_t> type_parsers{parse_type_array, parse_type_bool, parse_type_int, parse_type_float, parse_type_tuple, parse_type_variable};
}  //  namespace parser
