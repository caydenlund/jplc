...
namespace parser {
    ...
    */
    ...
    const std::vector<parser_t> expression_parsers {
            parse_expr_array_literal, parse_expr_call, parse_expr_false,         parse_expr_float,   parse_expr_integer,
            parse_expr_parentheses,   parse_expr_true, parse_expr_tuple_literal, parse_expr_variable};
